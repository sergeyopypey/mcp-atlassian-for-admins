...
test("parseWorkflowXml decodes ScriptRunner base64 arg values", () => {
  ...
  const inlineScript =
    "YCFgeyJzY3JpcHQiOiJpc3N1ZS5nZXRDdXN0b21GaWVsZFZhbHVlKDEzMTI3KSAmJiBpc3N1ZS5nZXRDdXN0b21G" +
    "aWVsZFZhbHVlKDEzMTA3KSAmJiBpc3N1ZS5nZXRDdXN0b21GaWVsZFZhbHVlKDEzMTYzKSIsInNjcmlwdFBhdGgiOm51bGx9";
  const externalPath =
    "YCFgeyJzY3JpcHQiOm51bGwsInNjcmlwdFBhdGgiOiJjb20vbWF5Zmxvd2VyL3dvcmtmbG93cy9wb3N0ZnVuY3Rpb25z" +
    "L2Fzc2lnblRvU2Vjb25kQnVkZ2V0QXBwcm92ZXIuZ3Jvb3Z5In0=";
  const xml = `<workflow>
    <steps>
      <step id="1" name="Open">
        <meta name="jira.status.id">1</meta>
          ...
          <action id="11" name="Go">
            ...
            <post-functions>
              <function type="class">
                ...
                <arg name="scriptDescription">YCFgU2lnbmVkIENvbnRyYWN0ID0gWWVz</arg>
  ...
  assert.equal(
    ...
    "issue.getCustomFieldValue(13127) && issue.getCustomFieldValue(13107) && issue.getCustomFieldValue(13163)",
  );
  assert.equal(args.scriptDescription, "Signed Contract = Yes");
  assert.equal(
    args.scriptPath,
